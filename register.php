...
<!-- sign up form -->
<table cellspacing='5'>
   <tr><td><label for="username">Username:</label></td><td> <input name="field1" type="text" /></td></tr>
   <tr><td><label for="email">Email:</label></td><td><input name="field2" type="text" /></td></tr>
   <tr><td><label for="fplayer">Favorite Player:</label></td><td><input name="field3" type="text" /></td></tr></br>
   <tr><td><label for="fteam">Favotite Team:</label></td><td><input name="field4" type="text" /></td>
